        ...
        <?php foreach ($trains as $train) : ?>
            <div class="bg-gradient-to-br w-96 from-pink-300 to-purple-400 rounded-lg p-8 flex flex-col justify-between mb-8">
                ...
                <div class="flex justify-center">
                    <a href="/Ticket/buy_ticket.php?trip_id=<?php echo $train['trip_id']; ?>&source=<?php echo $source; ?>&destination=<?php echo $destination; ?>" class="bg-blue-500 text-white font-semibold py-3 px-8 rounded-lg w-64 text-center hover:bg-blue-600 transition duration-300">Buy Ticket</a>
                </div>
            </div>
        <?php endforeach; ?>
    <?php elseif ($searched) : ?>
